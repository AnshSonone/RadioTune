...
function SearchResultsInner() {
  ...
  if (!querySearch.trim()) {
    return (
      <div className="theme-surface theme-page flex flex-col items-center justify-center min-h-[60vh] text-(--theme-muted) bg-(--theme-bg)">
  ...
  return (
    <div className="theme-surface theme-page min-h-screen bg-(--theme-bg) text-(--theme-text) select-none">
